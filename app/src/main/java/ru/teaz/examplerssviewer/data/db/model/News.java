package ru.teaz.examplerssviewer.data.db.model;
...
import ru.teaz.examplerssviewer.data.db.persister.LocalDateTimePersister;
import ru.teaz.examplerssviewer.data.net.XmlEnclosure;
import ru.teaz.examplerssviewer.data.net.XmlNews;
import ru.teaz.examplerssviewer.data.utils.DateUtils;
...
public class News {
    ...
    @DatabaseField(columnName = FIELD_SOURCE)
